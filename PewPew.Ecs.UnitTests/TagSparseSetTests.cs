...
public class TagSparseSetTests
{
    ...
    {
        var sparseSet = new TagSparseSet<EmptyComponent>(10, 2, _resizeStrategy, _stubEntityManager);
    ...
    {
        var sparseSet = new TagSparseSet<EmptyComponent>(10, 3, _resizeStrategy, _stubEntityManager);
