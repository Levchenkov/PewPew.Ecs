...
public class CompactSparseSetTests
{
    ...
    {
        var sparseSet = new CompactSparseSet<HealthComponent>(10, 2, _resizeStrategy, _stubEntityManager);
    ...
    {
        var sparseSet = new CompactSparseSet<HealthComponent>(10, 3, _resizeStrategy, _stubEntityManager);
    ...
    {
        var sparseSet = new CompactSparseSet<HealthComponent>(15, 4, _resizeStrategy, _stubEntityManager);

        Span<EntityId> entities = stackalloc EntityId[]
        {
            new EntityId(3, 1, 0),
            new EntityId(5, 1, 0),
            new EntityId(9, 1, 0),
    ...
    {
        var sparseSet = new CompactSparseSet<HealthComponent>(15, 1, _resizeStrategy, _stubEntityManager);
